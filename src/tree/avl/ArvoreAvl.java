...
public class ArvoreAvl {
    ...
    public void inserirAVL(No aComparar, No aInserir) {
        ...
        if (aComparar == null) {
            ...
            if (aInserir.getChave().getId() < aComparar.getChave().getId()) {
            ...
            } else if (aInserir.getChave().getId() > aComparar.getChave().getId()) {
                ...
                System.out.println("Nome já cadastrado, não pode ter chaves duplicadas.");
                // O nó já existe
            }
        }
    }
